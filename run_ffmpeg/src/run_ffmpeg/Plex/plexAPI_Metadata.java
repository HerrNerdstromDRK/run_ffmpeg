...
public class plexAPI_Metadata
{
	...
	public List< plexAPI_Image > Image = null ;
	public plexAPI_UltraBlurColors UltraBlurColors = null ;
	public List< plexAPI_Media > Media = null ;
	public List< plexAPI_Genre > Genre = null ;
	public List< plexAPI_Country > Country = null ;
	public List< plexAPI_Director > Director = null ;
	public List< plexAPI_Writer > Writer = null ;
	public List< plexAPI_Role > Role = null ;
	public List< plexAPI_Guid > Guid = null ;
	public List< plexAPI_Collection > Collection = null ;	
